...
<template>
  <div class="bg-light dark:bg-dark relative sm:p-3 md:pb-12">
    ...
    <ul class="h-[300px] overflow-y-auto flex flex-col gap-2 pt-2 px-3" v-if="posts.length">
      <li
        class="bg-white dark:bg-black cursor-pointer rounded-md max-h-[100px] py-1 sm:py-2 px-3 flex items-center"
    ...
    <div class="border border-gray-400 mt-5 py-[30px] flex justify-center items-center" v-else>
